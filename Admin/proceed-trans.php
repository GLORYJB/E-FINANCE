...
<div class="sidebar" id="sidebar">
            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a href="customer.php">All Customers</a></li>
                    ...
                    <li class="submenu">
                        <a href="#"><i class="fa fa-users"></i> <span>Budget</span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            <li><a href="savings-list.php">All budgets</a></li>
                            <li><a href="add-savings.php">Add budget</a></li>
                            
                        </ul>
                    </li>
                    <li class="submenu">
                        <a href="#"><i class="fa fa-users"></i> <span>Savings</span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            <li><a href="all-savings.php">Savings List</a></li>
                            <li><a href="add-savings.php">Add Savings</a></li>
                    ...
                    <li class="submenu">
                        <a href="#"><i class="fa fa-users"></i> <span>Revenue</span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            <li><a href="generate_rev.php">generate revenue</a></li>
                    ...
                    <li>
                        <a href="notifications.html"><i class="fa fa-bell-o"></i> <span>Notifications</span></a>
                    </li>
                    ...
                    <li class="submenu">
                        <a href="#"><i class="fa fa-gears"></i> <span>Settings</span> <span class="menu-arrow"></span></a>
    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">Gateway details</h4>
            </div>
        </div>
        <div class="col-md-6">
            <h4 class="card-title">Details</h4>
            <ul class="nav nav-tabs nav-tabs-solid nav-justified">
                <li class="nav-item"><a class="nav-link active" href="#solid-justified-tab1" data-toggle="tab">Card</a></li>
                <li class="nav-item"><a class="nav-link" href="#solid-justified-tab2" data-toggle="tab">M-pesa</a></li>
                <li class="nav-item"><a class="nav-link" href="#solid-justified-tab3" data-toggle="tab">Tigo-pesa</a></li>
            </ul>
            <div class="tab-content">
                <!-- tab 1 -->
                <div class="tab-pane show active" id="solid-justified-tab1">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Card Details</h4>
                    </div>
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                        <form action="visa_transaction_handler.php" method="POST">
    <!-- Your form fields for collecting Visa card details -->
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="number" name="card_no" required>
    </div>
    <div class="form-group">
        <label><span class="text-danger">*</span> CVC </label>
        <input class="form-control" type="text" name="cvc" required>
    </div>
    <div class="form-group">
        <label><span class="text-danger">*</span> Expiration Date</label>
        <input class="form-control datetimepicker" type="text" name="expiry_date" required>
    </div>
    <div class="m-t-20 text-center">
        <button class="btn btn-primary submit-btn" type="submit">PAY WITH VISA</button>
    </div>
</form>
                ...
                <div class="tab-pane" id="solid-justified-tab2">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">M-pesa Details</h4>
                    </div>
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <form action="new-transactions.php" method="POST">
                                <div class="form-group">
                                    <label><span class="text-danger">*</span> Full Name </label>
                                    <input class="form-control" type="text" name="fullname" required>
                                </div>
                                <div class="form-group">
                                    <label><span class="text-danger">*</span> M-pesa Number </label>
                                    <input class="form-control" type="number" name="mpesa_no" required>
                                </div>
                                <div class="m-t-20 text-center">
                                    <button class="btn btn-primary submit-btn" name="record_transaction">SAVE</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="solid-justified-tab3">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Tigo-pesa Details</h4>
                    </div>
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <form action="new-transactions.php" method="POST">
                                ...
                                <div class="form-group">
                                    <label><span class="text-danger">*</span> Tigo-pesa Number </label>
                                    <input class="form-control" type="number" name="tigo_no" required>
                                </div>
                                <div class="m-t-20 text-center">
                                    <button class="btn btn-primary submit-btn" name="record_transaction">SAVE</button>
                                </div>

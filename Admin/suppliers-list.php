...
<div class="main-wrapper">
        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="add-supplier.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Supplier</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            <tbody>
                                <!-- Replace the following rows with actual supplier data from your application -->
                                <tr>
                                    <td><img width="28" height="28" src="assets/img/supplier.jpg" class="rounded-circle m-r-5" alt="">Supplier ABC Ltd</td>
                                    <td>John Doe</td>
                                    <td>Industrial Area, Dar es Salaam</td>
                                    <td>(255)-74538-8765</td>
                                    <td>supplierabc@gmail.com</td>
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="edit-supplier.html"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_supplier"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <!-- Repeat the above structure for each supplier -->
                            </tbody>
                        </table>
                    </div>
                </div>
    ...
    <!-- Include the modified supplier content here -->
    <?php
// Include the footer
include('footer.php');
?>

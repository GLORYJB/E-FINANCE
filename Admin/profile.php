                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href="#"><img class="avatar" src="assets/img/prof.PNG" alt=""></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">Grayson dav</h3>
                                                <small class="text-muted">Entrepreneur</small>
                                                <div class="staff-id">User ID : USR-0001</div>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <span class="text"><a href="#">070-889-6484</a></span>
                                                </li>
                                                <li>
                                                    <span class="title">Email:</span>
                                                    <span class="text"><a href="#">gray@gmail.com</a></span>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text">714 upanga,ilala, dar es salaam</span>
                                                </li>
                                                <li>
                                    ...
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">Dar es salaam institute of technology</a>
                                                <div>ODD</div>

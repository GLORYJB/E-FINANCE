    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-8 col-9 text-right m-b-20">
                <a href="add-item.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add products</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <td><?php echo $row['category']; ?></td>
                                        ...
                                        <td><?php echo 'TZS' .$row['unit_price']; ?></td>
                                        <td><span class="custom-badge status-green"><?php echo $row['product_status']; ?></span></td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="edit-product.php?order_id=<?php echo $row['product_id']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>

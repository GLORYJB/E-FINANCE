...
if (isset($_POST['create_customer'])) {
    ...
    if (empty($name) || empty($email) || empty($address) || empty($phone) || empty($status)) {
        ...
        $query = "INSERT INTO customers (name, email, address, phone, profile, status, user_id) VALUES (?, ?, ?, ?, ?, ?, ?)";
                ...
                <form action="new-customer.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Country</label>
                                <select class="form-control select" name="country" id="countrySelect" required>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Region</label>
                                <select class="form-control select" name="region" id="regionSelect" required>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select" name="district" id="districtSelect" required>
                    ...
                    <div class="m-t-20 text-center">
                        <button class="btn btn-primary submit-btn" name="create_customer">Create Customer</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        if (country_id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#districtSelect').html('<option value="">Select District</option>'); // Reset districts dropdown
                }
            });
        }
    });

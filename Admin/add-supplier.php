...
<div class="main-wrapper">
        <div class="header">
            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item"><a href="transactions.html" class="nav-link">Upgrade</a></li>
                <li class="nav-item"><a href="reports.html" class="nav-link"></a></li>
                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Enter contact person">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>City</label>
                                    <select class="form-control select" id="citySelect">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Region</label>
                                    <select class="form-control select" id="regionSelect">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="profile-upload">
                                        <div class="upload-img">
                                            <img alt="" src="assets/img/supplier.jpg">
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="supplier_active" value="option1" checked>
                                <label class="form-check-label" for="supplier_active">
                                    Active
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="supplier_inactive" value="option2">
                        ...
                        <div class="m-t-20 text-center">
                            <button class="btn btn-primary submit-btn">Create Supplier</button>
                        </div>
                    </form>
                </div>
            </div>

        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">Capital</h4>
                </div>
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="new-capital.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add capital</a>
                </div>
...
if(isset($_SESSION['user_id'])) {
    ...
    $query = "SELECT * FROM capital WHERE user_id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>";
            echo "<td>" .$row['capital_id'] . "</a></td>";
            echo "<td>" . $row['capital_name'] . "</td>";
            echo "<td>TZS" . $row['amount'] . "</td>";
            echo "<td>" . $row['capital_date'] . "</td>";
            ...
            echo "<a class='dropdown-item' href='edit-payment.php'><i class='fa fa-pencil m-r-5'></i> Edit</a>";
            echo "<a class='dropdown-item' href='delete.php' data-toggle='modal' data-target='#delete_payment'><i class='fa fa-trash-o m-r-5'></i> Delete</a>";
            echo "</div>";
            echo "</div>";
            echo "</td>";
            echo "</tr>";
        ...
        echo "<tr><td colspan='6'>No capitals found</td></tr>";
    }

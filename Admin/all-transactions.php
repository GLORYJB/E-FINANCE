    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-8 col-9 text-right m-b-20">
                <a href="new-transactions.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Transaction</a>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-border table-striped custom-table datatable mb-0" id = "table">
                        ...
                        <tbody>
                            ...
                            $ret = "SELECT * FROM transactions WHERE user_id = $user_id";
                            $res = $conn->query($ret);
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="edit-transaction.php?transaction_id=<?php echo $row['transaction_id']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                        <!-- Example delete button in transaction list -->
                                                        <a class="dropdown-item" href="#" onclick="setTransactionIdToDelete(123); $('#delete_transaction').modal('show');">
...
<!-- Add the delete_transaction modal -->
<div id="delete_transaction" class="modal fade delete-modal" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                <img src="assets/img/sent.png" alt="" width="50" height="46">
                <h3>Are you sure you want to delete this transaction?</h3>
                <form id="deleteTransactionForm" method="post" action="delete-transaction.php">
                    <input type="hidden" name="transaction_id" id="transaction_id_to_delete">
                    <div class="m-t-20">
...
<!-- Add the script to set transaction_id -->
<script>
    function setTransactionIdToDelete(transactionId) {
        document.getElementById('transaction_id_to_delete').value = transactionId;
    }
</script>

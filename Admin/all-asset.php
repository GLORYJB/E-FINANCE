    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-8 col-9 text-right m-b-20">
                <a href="add-asset.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add assets</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <td><?php echo $row['description']; ?></td>
                                        <td><?php echo 'TZS' .$row['value']; ?></td>
                                        <td><?php echo $row['purchased_date']; ?></td>
                                        <td><span class="custom-badge status-green"><?php echo $row['asset_status']; ?></span></td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="edit-asset.php?asset_id=<?php echo $row['asset_id']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
